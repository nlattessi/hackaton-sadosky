...
public class ListaTareasActivity extends ListActivity {
	...
	protected List<SampleInfo> querySampleActivities() {
		...
		for (int i = 0; i < count; i++) {
			...
			try {
				meta = info.activityInfo.metaData.getBoolean("zoo");
	...
	class SampleAdapter extends BaseAdapter {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			// convertView.setTextAlignment(View.TEXT_ALIGNMENT_CENTER);

			Typeface tf = Typeface.createFromAsset(getAssets(),
					"fonts/DINbek-Medium.ttf");
